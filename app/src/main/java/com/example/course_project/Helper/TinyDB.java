...
public class TinyDB {
    ...
    public ArrayList<MaterialDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MaterialDomain> playerList =  new ArrayList<MaterialDomain>();

        for(String jObjString : objStrings){
            MaterialDomain player  = gson.fromJson(jObjString,  MaterialDomain.class);
    ...
    public void putListObject(String key, ArrayList<MaterialDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MaterialDomain player: playerList){
